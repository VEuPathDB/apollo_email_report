...
class ApolloReporter:
    ...
    def prepare_summary_gff(self):
        ...
        for organism_line in organism_file_handle:
            ...
            self._join_gff_to_master(organism, gff_file_path, master_gff_file_handle, gene_to_organism_lookup)
    ...
    def _join_gff_to_master(self, organism, gff_file_name, master_gff_file_handle, gene_organism):
    ...
    def prepare_summary_emails(self, master_gff_file_name, gene_organism, file_extension):
        ...
        for email in annotation_summary_emails:
            email_address, email_message = self._compose_message(email_dir, email, footer_text)
