...
class MyTestCase(unittest.TestCase):
    def test_writing_out_error(self):
        ...
        self.assertEqual(
            True,
            filecmp.cmp(
                "./output_files/simple_test_output.txt", file_name, shallow=False
            ),
        )
    ...
    def test_two_annotators(self):
        ...
        self.assertEqual(
            True,
            filecmp.cmp(
                "./output_files/annotator1_test_output.txt", file_name1, shallow=False
            ),
        )
        ...
        self.assertEqual(
            True,
            filecmp.cmp(
                "./output_files/annotator2_test_output.txt", file_name2, shallow=False
            ),
        )
    ...
    def test_two_species(self):
        ...
        self.assertEqual(
            True,
            filecmp.cmp(
                "./output_files/species_test_output.txt", file_name, shallow=False
            ),
        )
    ...
    def test_two_genes(self):
        ...
        self.assertEqual(
            True,
            filecmp.cmp(
                "./output_files/twoGenes_test_output.txt", file_name, shallow=False
            ),
        )
    ...
    def test_two_mrna(self):
        ...
        self.assertEqual(
            True,
            filecmp.cmp(
                "./output_files/twomrna_test_output.txt", file_name, shallow=False
            ),
        )
