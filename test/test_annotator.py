...
class MyTestCase(unittest.TestCase):
    def test_summary(self):
        ...
        self.assertEqual(1, mini_gff.annotators['annotator1@ebi.ac.uk'].total_gene_count)
        self.assertEqual(1, mini_gff.annotators['annotator1@ebi.ac.uk'].finished_gene_count)
        self.assertEqual(2, mini_gff.annotators['annotator2@ebi.ac.uk'].finished_mrna_count)
